          ...
          <div className="w-full lg:w-1/2 p-8 flex flex-col justify-center items-center">
            ...
            <form className='space-y-4 w-full max-w-sm' onSubmit={handleRegister}>
              <div>
                ...
                <input name='username' type='text' className='w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' required />
              </div>
              <div>
              ...
              <div>
                ...
                <div className="relative">
                  <input name='confirmPass' type={confirmEye ? "text" : "password"} className='w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500' required />
